 ...
 *
 */
public class FuelRestarted extends EcsSnmpEvent {
    public static class Builder extends EcsSnmpEvent.Builder<Builder, FuelRestarted> {
        private Builder() {
            event = new FuelRestarted();
        }
    ...
    public static int Minor = 2031705;
    private static int timeoutInSeconds = 300;

    protected FuelRestarted() {
